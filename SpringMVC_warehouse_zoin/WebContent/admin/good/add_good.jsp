                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="${pageContext.request.contextPath}/good/add">
                        ...
                        <div class="col-lg-3">
                            <select class="form-control" name="repoID">
								<c:forEach items="${repolist}" var="repo">
									<option value="${repo.id }" id="repoID">${repo.repositoryName }</option>
								</c:forEach>                            	
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" readonly="readonly"  value="2017-12-02" size="16" class="form-control" name="manufactureDate">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-3">
                                            <input class="form-control "  name="supplierPhone" type="text" id="phone"/>
                                            <div id="phonetip"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
$(function(){ 
    ...
    $("#name").blur(function(){   //当该控件失去焦点时发生  
        ...
        $.post("validateNameAdd.action?name="+text+"&repoID="+repoID,null,function(response){      
                   //以POST方式跳转到action里面的方法中进行处理，并返回处理结果response  
             if(response=="exist"){ //根据返回值进行处理  
                          
                document.getElementById("name").focus();//用户名输入控件获得焦点  
                             
                    document.getElementById("showResult").innerHTML="<font color='red'>"+"该货物已存在,入库增加数量"+"</font>";   
                                //在div中提示用户该用户名已经存在  
