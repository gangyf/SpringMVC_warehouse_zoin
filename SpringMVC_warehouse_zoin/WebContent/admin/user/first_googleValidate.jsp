...
<div class="container">
    ...
    <form class="form-signin" action="${pageContext.request.contextPath}/user/toGoogle" method="post">
        ...
        <div class="login-wrap">
            ...
            <img src="${pageContext.request.contextPath}/admin/QRCode/${user.id }.jpg"><br>
			请在您的谷歌APP上输入以下字符串作为密钥:${user.secretKey}<br>
