                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                                <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="${pageContext.request.contextPath}/repo/update">
                                   <div class="form-group">
                       
                         </div>
                         			<input type="hidden" name="id" value="${repo.id}" id="goodID"><br/>
                         	
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-2">仓库名称</label>
                                        <div class="col-lg-3">
                                            <input class=" form-control" id="name" name="repositoryName" type="text" value="${repo.repositoryName }"/>
                                        	<div id="nametip"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
$(function(){ 
    ...
    $("#name").blur(function(){   //当该控件失去焦点时发生  
        ...
        $.post("validateName.action?name="+text+"&goodID="+goodID,null,function(response){      
